    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-[hsl(var(--sidebar-background))] group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-[hsl(var(--sidebar-border))] group-data-[variant=floating]:shadow-lg"
          >
            {children}
          </div>
        </div>
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // General styling for the main content area to look like a panel
        "md:m-2 md:rounded-xl md:shadow-lg",
        className
      )}
      {...props}
    />
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-[hsl(var(--sidebar-foreground)_/_0.7)] outline-none ring-[hsl(var(--sidebar-ring))] transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-[hsl(var(--sidebar-foreground))] outline-none ring-[hsl(var(--sidebar-ring))] transition-transform hover:bg-[hsl(var(--sidebar-item-hover-bg))] hover:text-[hsl(var(--sidebar-item-hover-fg))] focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-[hsl(var(--sidebar-item-active-fg))]",
        className
      )}
      {...props}
    />
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-[hsl(var(--sidebar-item-fg))] outline-none ring-[hsl(var(--sidebar-ring))] hover:bg-[hsl(var(--sidebar-item-hover-bg))] hover:text-[hsl(var(--sidebar-item-hover-fg))] focus-visible:ring-2 active:bg-[hsl(var(--sidebar-item-active-bg))] active:text-[hsl(var(--sidebar-item-active-fg))] disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-[hsl(var(--sidebar-item-icon-fg))]",
        "data-[active=true]:bg-[hsl(var(--sidebar-item-active-bg))] data-[active=true]:text-[hsl(var(--sidebar-item-active-fg))]",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
